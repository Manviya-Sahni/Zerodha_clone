    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Stating an SIP</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Managing your Portiolio</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Coin App</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Moving t</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Cover</a>
          <br />
        </div>
      </div>
    </div>
